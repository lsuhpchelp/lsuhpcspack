...
_versions = {
    ...
    '11.2.2': {
        'Linux-x86_64': ('955ae5d59531923d32a3bfe3f68a7dfe', 'https://developer.download.nvidia.com/compute/cuda/11.2.2/local_installers/cuda_11.2.2_460.32.03_linux.run')},
    '11.0.2': {
